...
def plot_multi_mass_sweep(
    ...
    ax.set_ylabel(style.ylabel, fontsize=14)
    ax.set_xlabel(style.xlabel, fontsize=14)
...
if __name__ == "__main__":
    plot_multi_mass_sweep(
        ...
        output_path         = "/home/cudagl/dataset/RAS_results/box5/success_rate_vs_signed_normalized_moment_arm_multi_mass.pdf",
        show                = False,
